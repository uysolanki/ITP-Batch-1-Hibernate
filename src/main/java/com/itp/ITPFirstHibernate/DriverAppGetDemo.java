...
public class DriverAppGetDemo {
	...
	public static void main(String[] args) {
    	...
    	Employee emp1=session1.get(Employee.class,1); //not found in session so query the db
    	System.out.println(emp1.getEname());
    	
    	Employee emp2=session1.get(Employee.class,2); //not found in session so query the db
